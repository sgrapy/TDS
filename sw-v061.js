...
const CACHE_NAME = 'taverne-des-scores-v0-6-3-safe';
const APP_SHELL = [
  './', './index.html', './home.html', './jeu.html', './loading.html',
  './style.css?v=0.6.3',
  './appUi-062.js?v=0.6.3', './managePlayers-062.js?v=0.6.3', './saveManager-062.js?v=0.6.3',
  './pwa-register-062.js?v=0.6.3', './site.webmanifest?v=0.6.3',
  './js/gameLoader.js?v=0.6.3', './js/scoreGameEngine.js?v=0.6.3',
  './js/skyjo.js?v=0.6.3', './js/simonette.js?v=0.6.3', './js/belote-coinche.js?v=0.6.3',
  './js/tarot.js?v=0.6.3', './js/rami.js?v=0.6.3', './js/tarotafricain.js?v=0.6.3',
  './js/papayoo.js?v=0.6.3', './js/uno.js?v=0.6.3', './js/paletbreton.js?v=0.6.3',
  './js/molkky.js?v=0.6.3', './js/petanque.js?v=0.6.3',
